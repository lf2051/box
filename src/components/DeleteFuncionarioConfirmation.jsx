...
const DeleteFuncionarioConfirmation = ({ isOpen, onClose, funcionario, onConfirm }) => {
      ...
      <AnimatePresence>
        ...
        >
          <div className="p-6 space-y-4 text-center">
            ...
            <h3 className="text-xl font-bold text-white">Excluir Funcionário?</h3>
            
            <p className="text-gray-400">
              Tem certeza que deseja <span className="text-[#EF4444] font-bold">EXCLUIR</span> este funcionário?
            </p>
            ...
            <div className="bg-[#2d3e52] rounded-lg p-4 text-left border border-gray-600 mt-4 space-y-2">
              ...
              <div className="flex justify-between">
                 ...
                 <span className="text-white text-sm">{funcionario.email}</span>
              </div>
               <div className="flex justify-between">
                 <span className="text-gray-400 text-sm">Cargo</span>
                 <span className="text-white text-sm">{funcionario.cargo}</span>
              </div>
            </div>
...
export default DeleteFuncionarioConfirmation;